<template>
  <div class="privacy-container">
    <h1>Engster Privacy Policy</h1>
    <section>
      <p></p>
      <p class="sub_p mgt10">
        <span class="colorLightBlue">1. 개인정보의 처리 목적</span>
        <engster
          >(‘https://engster.co.kr’이하 ‘Engster’) 은(는) 다음의 목적을 위하여
      ...
      <p class="sub_p mgt10">
        ①
        <engster
          >(‘https://engster.co.kr’이하 ‘Engster’) 은(는) 정보주체로부터
          개인정보를 수집할 때 동의 받은 개인정보 보유․이용기간 또는 법령에 따른
          개인정보 보유․이용기간 내에서 개인정보를 처리․보유합니다.</engster
        >
      </p>
      <p class="sub_p mgt10">
      ...
      <p class="ls2">
        ① 정보주체는 Engster(‘https://engster.co.kr’이하 ‘Engster) 에 대해
      ...
      <br /><br />
      <p class="lh6 bs4">
        <strong>4. 처리하는 개인정보의 항목 작성 </strong><br /><br />
        ①
        <em class="emphasis"
          ><engster>('https://engster.co.kr'이하 'Engster')</engster></em
        >은(는) 다음의 개인정보 항목을 처리하고 있습니다.
      </p>
      <ul class="list_indent2 mgt10">
        <li class="tt">1&lt;유저 데이터&gt;</li>
        <li>
      ...
      <p class="ls2">
        ① Engster 은 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고
      ...
      <p class="sub_p mgt10">
        ...
        <span class="colorLightBlue"
          >Engster(‘https://engster.co.kr’이하 ‘Engster)</span
        >
      ...
      <ul class="list_indent2 mgt10">
        ...
        <li>연락처: engsteradm@gmail.com,</li>
      </ul>
      <p></p>
      <p class="sub_p">
        ② 정보주체께서는 Engster(‘https://engster.co.kr’이하 ‘Engster) 의
        서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의,
        불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로
        문의하실 수 있습니다. Engster(‘https://engster.co.kr’이하 ‘Engster)
      ...
      <p class="lh6 bs4">
        <strong
          >9. 개인정보의 안전성 확보 조치
          <em class="emphasis"><engster>('Engster')</engster></em
